...
print()
print("Entonces te identificas como", sexo)
print()

#Número de teléfono
telefono = str(input("¿Cuál es tu número de celular? Sin incluir +569: "))
print()
print("Tu teléfono es el +569", telefono)
print()

#País donde vives

pais = input("Finalmente, ¿de qué país eres?: ")
print()
print("Eres de ", pais)
print()
