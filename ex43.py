...
class CentralCorridor(Scene):
    ...
    def enter(self):
        ...
        corridor to the Weapons Armory when a Gothon jumps out, red scaly
        skin, dark grimy teeth and evil clown costume flowing around his
        hate filled body. He's blocking the door to the Armory and about to
        ...
        if action == "shoot!":
            ...
            His clown costume is flowing and moving around his body, wich throws off
            your aim. Your laser hits his costume but misses him entirely. This
            completely ruins his brand new costume his mother bought him, wich makes
            him fly into an insane rage and blast you repeatedly in the face until 
            ...
            pass out. You wake up shortly after only to die as the Gothon stomps on
            ...
            print(dedent("""
            Luckly for you they made you learn Gothon insults in the academy. You
            tell the one Gothon joke you know: jiuq2eijsadkjskad. The Gothon stops, 
            tries not to laugh, then busts out laughing and can't move. While he's
            laughing you run and shoot him square in the head putting him down, then
...
class LaserWeaponArmory(Scene):
    ...
    def enter(self):
        ...
        if guess == code:
            print(dedent("""
            The container clicks open and the seal breaks, lettin gas out. You grab
...
class TheBridge(Scene):
    ...
    def enter(self):
        ...
        has an even uglier clown costume than the last. They haven't puller their 
        eapons out yet, as they see the active bomb under your arm and don't want to 
        set it off.
        """))
        action = input("> ")
        ...
        if action == "throw the bomb":
            ...
            the door. Right as you drop it a Gothon shoots you right in the back killing you.
            As you die you see another Gothon frantically try to disarm the bomb. You 
            ...
            print(dedent("""
            you pint your blaster at the bomb under your arm and the Gothons put their 
            hands up and start to sweat. You inch backward to the door, open it, and 
            then carefully place the bomb on the floor, pointing your blaster at it. You 
            then jump back through the door, punch the close button and blast the lock so 
            the Gothons can't get out. Now that the bomb is placed you run to the escape 
...
class EscapePod(Scene):
    ...
    def enter(self):
        ...
        but you don't have time to look. There's 5 pods, wich one do you take?
        """))
